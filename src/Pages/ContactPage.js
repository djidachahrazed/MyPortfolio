        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'+213 698022761'} text2={'+213 540618097'} title={'Phone'}/>
                    <ContactItem icon={email} text1={'djidachahrazeda6@gmail.com'} text2={'chahrazeddjida@outlook.com'} title={'Email'}/>
                    <ContactItem icon={location} text1={'Nador,Tipaza'} text2={'Tipaza'} title={'Address'}/>
                </div>
            </div>
        </div>
    )
